...
static const struct ram_bank banks[] = {
	...
	/* RAM00 sections 0-15 and RAM01 sections 16-23 within MEMCONF POWER[0].
	 * RAM02 (Wi-Fi IPC shared memory) and RAM03 (FLPR RAM, boot ROM workspace,
	 * KMU/CRACEN key exchange) are intentionally excluded so they are never
	 * powered down in System ON.
	 */
	{ .start = 0x20000000UL, .section_count = 24, .section_size = 0x8000 },
