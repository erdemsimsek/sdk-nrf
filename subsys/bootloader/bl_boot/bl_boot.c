...
#else
#define S0_IMAGE_ADDRESS	(FIXED_PARTITION_OFFSET(slot0_partition) + RWX_SKIP_SIZE)
#define S0_IMAGE_SIZE		(FIXED_PARTITION_SIZE(slot0_partition) - RWX_SKIP_SIZE)
#define S1_IMAGE_ADDRESS	(FIXED_PARTITION_OFFSET(slot1_partition) + RWX_SKIP_SIZE)
#define S1_IMAGE_SIZE		(FIXED_PARTITION_SIZE(slot1_partition) - RWX_SKIP_SIZE)
#endif
